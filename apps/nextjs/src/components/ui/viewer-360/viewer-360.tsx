...
export function Viewer360({ imageUrl, initialZoom, isAutoplayEnabled, isZoomEnabled, showDisplayHint }: TProps) {
  ...
  return (
    <div className='size-full relative group'>
      <div className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 size-[calc(100%_-_20px)] max-w-40 max-h-40 group-hover:opacity-0 group-hover:pointer-events-none transition-opacity duration-500'>
        <svg
          fill='#FFFFFF'
          version='1.1'
          xmlns='http://www.w3.org/2000/svg'
          className='size-full'
          style={{ filter: 'drop-shadow(0px 5px 5px black)' }}
          viewBox='0 0 480 480'
        >
          <title>Browse in 360</title>
          <g>
            <g>
              <g>
                <path
