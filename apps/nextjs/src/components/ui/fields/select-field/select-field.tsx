      ...
      {({ isOpen }) => (
        <>
          <MotionLabel
            ...
            initial={false}
            animate={
              !!controlledSelectedKey || isOpen
                ? { translateY: '-105%', scale: 0.85, originX: 0 }
          ...
          <Popover
            ...
            className='min-w-[var(--trigger-width)] bg-bg rounded-md border border-bg-border overflow-hidden'
          >
