...
import type { FormaImageAssetDocumentType, FormaImageInstanceObjectType } from 'types/generated/sanity-types-generated';

export function getImageAltText(image: { altText?: string }): string {
  return image.altText ?? 'Forma Artwork';
}

export async function getImageAltText2(
